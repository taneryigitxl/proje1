...
- Marketin üst kısmında Atlas ve Nita'nın güncel altın bakiyeleri ayrı ayrı gösterilir.
...
Boss savaşında düşen takım arkadaşı oyunu bitirmez. Dokuz saniye sonra beliren revive kupasını hayatta kalan oyuncu alırsa takım arkadaşı iki canla geri döner. `Ctrl` + `ı` gizli test kısayolu normal bölümleri doğrudan geçirir; beşinci bölümde boss ve drobu atlanamaz.

## Köy, demirci ve Öfke Zırhı

Beşinci bölüm boss'u yenildiğinde biri Atlas'a, biri Nita'ya ait toplam iki **Öfkenin Kalbi** düşer. Yaşayan karakterlerden biri düşen kalplere gidip almadan bölüm sonu pazarına geçilmez. HUD'daki **Köy** düğmesi Kızıl Ocak Köyü'nü açar; köyde şimdilik etkileşime açık tek NPC Demirci Varko'dur. Her kalp, ilgili kahraman için siyah ve kırmızı detaylı bir Öfke Zırhı üretir. Köy açıkken aynı düğme **Göreve Devam Et** olarak değişir.
