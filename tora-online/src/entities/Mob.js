...
export class Mob extends Entity {
  ...
  die() {
    this.alive = false; this.state = "dead"; this.targetId = null; this.aggro = false; this.respawnTimer = 7;
    this.#play("death", false, true);
    setTimeout(() => { if (!this.alive) this.root.setEnabled(false); }, 1700);
  }

  respawn() {
    this.health = this.maxHealth; this.alive = true; this.state = "idle"; this.aggro = false;
